...
const descriptionField = document.getElementById("id_content");
const genreField = document.getElementById("id_intro");
const platformField = document.getElementById("id_topic")
